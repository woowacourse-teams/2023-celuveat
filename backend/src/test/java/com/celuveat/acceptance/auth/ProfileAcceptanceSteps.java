...
public class ProfileAcceptanceSteps {
    ...
    public static ProfileResponse 예상_응답(OauthMember 멤버) {
        return new ProfileResponse(멤버.nickname(), 멤버.profileImageUrl());
    }
    ...
    public static void 응답을_검증한다(ExtractableResponse<Response> 응답, ProfileResponse 예상_응답) {
        ProfileResponse responseBody = 응답.as(ProfileResponse.class);
