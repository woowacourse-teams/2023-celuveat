...
public class SeedData {
    ...
    public List<RestaurantSearchQueryResponse> insertSeedData() {
        ...
        videoRepository.saveAll(List.of(
                영상("말랑1호점-말랑", 말랑, 말랑1호점),
                영상("말랑1호점-도기", 도기, 말랑1호점),
                영상("말랑1호점-로이스", 로이스, 말랑1호점),
                영상("말랑2호점-말랑", 말랑, 말랑2호점),
                영상("말랑3호점-말랑", 말랑, 말랑3호점),
                영상("도기1호점-도기", 도기, 도기1호점),
                영상("도기1호점-오도", 오도, 도기1호점),
                영상("도기1호점-로이스", 로이스, 도기1호점),
                영상("도기2호점-도기", 도기, 도기2호점),
                영상("도기3호점-도기", 도기, 도기3호점),
                영상("도기3호점-오도", 오도, 도기3호점),
                영상("오도1호점-오도", 오도, 오도1호점),
                영상("오도1호점-로이스", 로이스, 오도1호점),
                영상("오도1호점-말랑", 말랑, 오도1호점),
                영상("오도2호점-오도", 오도, 오도2호점),
                영상("로이스1호점-말랑", 말랑, 로이스1호점),
                영상("로이스1호점-도기", 도기, 로이스1호점),
                영상("로이스1호점-오도", 오도, 로이스1호점),
                영상("로이스1호점-로이스", 로이스, 로이스1호점),
                영상("로이스2호점-로이스", 로이스, 로이스2호점)
        ));
    ...
    public List<Video> insertVideoSeedData() {
        ...
        return videoRepository.saveAll(List.of(
                        영상("ww.comA?v=absa", 로이스, 로이스1호점),
                        영상("ww.comB?v=adBwssa", 도기, 로이스1호점),
                        영상("ww.comC?v=adsbs12a", 말랑, 로이스2호점),
                        영상("ww.comD?v=sbsa", 오도, 로이스2호점)
                )
        );
    }
