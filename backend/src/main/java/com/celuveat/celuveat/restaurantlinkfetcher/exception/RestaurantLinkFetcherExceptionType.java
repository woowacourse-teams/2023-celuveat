...
public enum RestaurantLinkFetcherExceptionType implements BaseExceptionType {
    ...
    RestaurantLinkFetcherExceptionType(int errorCode, HttpStatus httpStatus, String errorMessage) {
